...
all: build/wxmoni_bin build/wxmoni_sobel_bin build/wxmoni_mandel_bin build/daemon_bin build/simple_cpp_bin build/simple_ocl_bin build/bit_patch_bin build/cynq_example_bin build/cynq_example_full_bin build/blackeuro_bin build/cynq_example_blackeuro_bin $(PROTO_PY_SRCS)
