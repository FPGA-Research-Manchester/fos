...
HD_PWD='/home/joe/Ultra96-PYNQ/Ultra96/sensors96b/sensors96b/sensors96b.runs/sensors96b_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensors96b_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensors96b_auto_pc_0.tcl
