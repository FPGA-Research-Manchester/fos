...
HD_PWD='/home/joe/Ultra96-PYNQ/Ultra96/sensors96b/sensors96b/sensors96b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sensors96b_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensors96b_wrapper.tcl -notrace
