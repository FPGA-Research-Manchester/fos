...
void mandelbrot(unsigned int ImageWidth, unsigned int ImageHeight,
				unsigned int MaxIterations,
				fixed_point_t cRe, fixed_point_t cIm,
				fixed_point_t zoom, char display[MaxImageWidth * MaxImageHeight])
{
//#pragma HLS DATAFLOW
#pragma HLS EXPRESSION_BALANCE

#pragma HLS INTERFACE m_axi port=display offset=slave bundle=gmem
...
#pragma HLS INTERFACE s_axilite port=display bundle=control
